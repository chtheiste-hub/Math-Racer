...
const ADDITION_CATEGORIES: { id: AdditionCategory; title: string; description: string; examples: string; icon: keyof typeof MaterialCommunityIcons.glyphMap }[] = [
  {
    id: "1",
    title: "Small Numbers",
    description: "Answers are 10 or less",
    examples: "3 + 4 = 7",
  ...
  },
  {
    id: "3",
    title: "Passing 10",
    description: "Single digits that cross 10 (answers 11\u201319)",
    examples: "7 + 5 = 12",
  ...
  },
  {
    ...
    description: "Cross a tens boundary from 10\u201389",
    examples: "27 + 5 = 32",
  ...
  },
  {
    id: "5",
    title: "Double Digits",
    description: "Two double-digit numbers added together",
    examples: "23 + 45 = 68",
    ...
    <View style={styles.screen}>
      ...
      >
        <View style={styles.heroSection}>
          ...
          <Text style={styles.heroTitle}>Addition</Text>
